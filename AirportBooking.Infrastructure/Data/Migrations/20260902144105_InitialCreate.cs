        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirlineName = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: false),
                    AirlineIataCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabinClass = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_AirlineIataCode",
                table: "Flights",
                column: "AirlineIataCode");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_DepartureTimeUtc",
                table: "Flights",
                column: "DepartureTimeUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_OriginAirportId_DestinationAirportId_DepartureTimeU~",
                table: "Flights",
                columns: new[] { "OriginAirportId", "DestinationAirportId", "DepartureTimeUtc" });
